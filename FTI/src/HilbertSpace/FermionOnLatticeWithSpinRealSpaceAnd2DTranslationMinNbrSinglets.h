...
class FermionOnLatticeWithSpinRealSpaceAnd2DTranslationMinNbrSinglets : public FermionOnLatticeWithSpinRealSpaceAnd2DTranslation
{
 ...
 protected:
  ...
  virtual long EvaluateHilbertSpaceDimension(int nbrFermions, int nbrSinglets);
  ...
  // return value = Hilbert space dimension
  virtual long EvaluateHilbertSpaceDimension(int nbrFermions, int nbrSpinUp, int nbrSinglets);
