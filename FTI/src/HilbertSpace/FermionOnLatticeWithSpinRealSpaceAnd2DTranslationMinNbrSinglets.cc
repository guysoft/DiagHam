...
{  
  ...
  this->LargeHilbertSpaceDimension = this->EvaluateHilbertSpaceDimension(this->NbrFermions, 0);
...
{  
  ...
  this->MaximumSignLookUp = 16;
  this->LargeHilbertSpaceDimension = this->EvaluateHilbertSpaceDimension(this->NbrFermions, this->NbrFermionsUp, 0);
  cout << "intermediate Hilbert space dimension = " << this->LargeHilbertSpaceDimension << endl;
  if (this->LargeHilbertSpaceDimension >= (1l << 30))
    this->HilbertSpaceDimension = 0;
  else
...
long FermionOnLatticeWithSpinRealSpaceAnd2DTranslationMinNbrSinglets::EvaluateHilbertSpaceDimension(int nbrFermions, int nbrSinglets)
{
...
long FermionOnLatticeWithSpinRealSpaceAnd2DTranslationMinNbrSinglets::EvaluateHilbertSpaceDimension(int nbrFermions,int nbrSpinUp, int nbrSinglets)
{
