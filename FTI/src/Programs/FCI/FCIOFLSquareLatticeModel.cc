  ...
  */
  ...
  if (Manager.GetBoolean("singleparticle-spectrum") == true)
	...
	ExportOneBody = true;
      ...
      TightBindingModelOFLSquareLattice TightBindingModel(LaserStrength,Manager.GetDouble("gamma-x"), Manager.GetDouble("gamma-y"), Architecture.GetArchitecture(), ExportOneBody);
