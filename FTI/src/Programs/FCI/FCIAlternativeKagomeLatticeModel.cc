...
int main(int argc, char** argv)
{
    ...
    lenFilePrefix += sprintf(FilePrefix + lenFilePrefix, "_t1_%f_t2_%f_l1_%f_l2_%f_gx_%f_gy_%f", Manager.GetDouble("t1"), Manager.GetDouble("t2"), Manager.GetDouble("l1"), Manager.GetDouble("l2"),
