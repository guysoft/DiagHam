...
//#include "Hamiltonian/ParticleOnLatticeZhangQiLatticeSingleBandThreeBodyHamiltonian.h"
...
int main(int argc, char** argv)
{
  ...
  for (int i = MinKx; i <= MaxKx; ++i)
      ...
      for (int j = MinKy; j <= MaxKy; ++j)
	{
	  ...
	  if (Manager.GetBoolean("three-body") == false)
	    { 
//	      Hamiltonian = new ParticleOnLatticeZhangQiSingleBandHamiltonian(Space, NbrParticles, NbrSitesX, NbrSitesY, Manager.GetDouble("u-potential"),  Manager.GetDouble("v-potential"),   &TightBindingModel, Manager.GetBoolean("flat-band"), Architecture.GetArchitecture(), Memory);
	    }
	  else
	    { 
//	      Hamiltonian = new ParticleOnLatticeZhangQiSingleBandThreeBodyHamiltonian(Space, NbrParticles, NbrSitesX, NbrSitesY, Manager.GetDouble("u-potential"), 0.0,
