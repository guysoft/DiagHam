...
ParticleOnLatticeRealSpaceAnd2DTranslationHamiltonian::ParticleOnLatticeRealSpaceAnd2DTranslationHamiltonian(ParticleOnSphere* particles, int nbrParticles, int nbrSites, int xMomentum, int maxXMomentum, int yMomentum, int maxYMomentum, double uPotential, AbstractArchitecture* architecture, long memory)
{
...
void ParticleOnLatticeRealSpaceAnd2DTranslationHamiltonian::EvaluateOneBoyFactorsFromTightBingding (HermitianMatrix& tightBinding)
{
