...
class ParticleOnLatticeRealSpaceAnd2DTranslationHamiltonian : public ParticleOnLatticeTimeReversalBreakingSingleBandHamiltonian
{
 ...
 public:
  ...
  ParticleOnLatticeRealSpaceAnd2DTranslationHamiltonian(ParticleOnSphere* particles, int nbrParticles, int nbrSites, 
							...
							double uPotential, AbstractArchitecture* architecture, long memory = -1);
 ...
 protected:
  ...
  //
  virtual void EvaluateOneBoyFactorsFromTightBingding (HermitianMatrix& tightBinding);
