...
int main(int argc, char** argv)
{
  ...
  for (int Pos = 0;Pos < NbrMomenta; ++Pos)
      ...
      else
	{
      ...
      AbstractQHEHamiltonian* Hamiltonian = new ParticleOnTorusWithSpinAndMagneticTranslationsNBodyHardCoreHamiltonian(Space, NbrBosons, MaxMomentum, XMomentum, XRatio,
