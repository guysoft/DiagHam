...
int main(int argc, char** argv)
{
  ...
  for (; Ky <= Max; Ky+=2 )
	...
	Memory = Architecture.GetArchitecture()->GetLocalMemory();
      ...
      AbstractQHEHamiltonian* Hamiltonian = new ParticleOnCylinderGaffnianHamiltonian (Space, NbrParticles, MaxMomentum, XRatio, Confinement, ElectricFieldParameter, BFieldParameter, Architecture.GetArchitecture(), Memory);
