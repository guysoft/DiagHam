...
int main(int argc, char** argv)
{
  ...
  (*SystemGroup) += new SingleDoubleOption  ('u', "u-potential", "Hubbard potential strength", 1.0);
  ...
  sprintf (EigenvalueOutputFile, "fermions_cherninsulator_n_%d_x_%d_y_%d.dat", NbrParticles, NbrSitesX, NbrSitesY);
