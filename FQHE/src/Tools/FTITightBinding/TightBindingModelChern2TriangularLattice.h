...
class TightBindingModelChern2TriangularLattice : public Abstract2DTightBindingModel
{
 ...
 public:
  ...
  TightBindingModelChern2TriangularLattice(int nbrSiteX, int nbrSiteY, double t1,  double t2, double phi, double mus,  double gammaX, double gammaY, bool storeOneBodyMatrices = true);
