...
class AbstractZDensityProfile {
 ...
 public:
  ...
  static AbstractZDensityProfile* CreateZDensityProfile (unsigned int type, double width);

  // a static class function to return the name of a type of DensityProfile
  static char *DensityProfileName(unsigned int type);
