...
ComplexMatrix FermionOnSquareLatticeWithSU4SpinMomentumSpace::TransformationMatrixOneBodyBasis(ComplexMatrix* oneBodyBasis)
{
  int* TmpMomentumIndices = new int [this->NbrFermions];
  int* TmpSU4Indices = new int [this->NbrFermions];
  int* TmpSU4Indices2 = new int [this->NbrFermions];
...
void FermionOnSquareLatticeWithSU4SpinMomentumSpace::TransformOneBodyBasisRecursive(ComplexVector& targetState, Complex coefficient,
...
ComplexMatrix FermionOnSquareLatticeWithSU4SpinMomentumSpace::TransformationMatrixSU4ToSU2(FermionOnSquareLatticeWithSpinMomentumSpace* targetSpace, int spinUp, int spinDown)
{
