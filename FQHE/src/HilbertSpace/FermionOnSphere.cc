...
RealSymmetricMatrix FermionOnSphere::EvaluatePartialDensityMatrixRealSpacePartition (int nbrFermionSector, int lzSector, double theta, RealVector& groundState)
{
  if (nbrFermionSector == 0)
    {
      if (lzSector == 0)
