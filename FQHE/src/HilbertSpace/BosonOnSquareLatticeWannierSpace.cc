  ...
  if ( this->LargeHilbertSpaceDimension > 0l)
    {
      ...
      long TmpLargeHilbertSpaceDimension = this->GenerateStates(TmpStateDescription, this->NbrBosons, this->NbrSiteX - 1, this->NbrSiteY - 1, 0, this->LzMax + this->NbrBosons, 0l);
...
HermitianMatrix BosonOnSquareLatticeWannierSpace::EvaluatePartialDensityMatrixParticlePartition (int nbrParticleSector, int kxSector, int kySector, ComplexVector& groundState, AbstractArchitecture* architecture)
{
  ...
  BosonOnSquareLatticeWannierSpace SubsytemSpace (nbrParticleSector, this->NbrSiteX, this->NbrSiteY, kxSector, kySector);
  HermitianMatrix TmpDensityMatrix (SubsytemSpace.GetHilbertSpaceDimension(), true);
  BosonOnSquareLatticeWannierSpace ComplementarySpace (ComplementaryNbrParticles, this->NbrSiteX, this->NbrSiteY, ComplementaryKxMomentum, ComplementaryKyMomentum);
