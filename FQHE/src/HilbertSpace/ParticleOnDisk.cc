...
double ParticleOnDisk::AA (int index, int n1, int n2)
{
  return 0.0;
}
...
double ParticleOnDisk::ProdA (int index, int* n, int nbrIndices)
{
  return 0.0;
}
...
int ParticleOnDisk::AdAd (int m1, int m2, double& coefficient)
{
...
int ParticleOnDisk::ProdAd (int* m, int nbrIndices, double& coefficient)
{
  return this->HilbertSpaceDimension;
}
