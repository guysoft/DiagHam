...
BosonOnSphereWithSpinFast::BosonOnSphereWithSpinFast ()
{
}
...
//
BosonOnSphereWithSpinFast::BosonOnSphereWithSpinFast (int nbrBosons, int totalLz, int lzMax, int totalSpin, unsigned long memory)
{
  cout << "BosonOnSphereWithSpinFast"<<endl;
...
BosonOnSphereWithSpinFast::BosonOnSphereWithSpinFast(const BosonOnSphereWithSpinFast& bosons)
{
...
BosonOnSphereWithSpinFast& BosonOnSphereWithSpinFast::operator = (const BosonOnSphereWithSpinFast& bosons)
{
  delete[] this->TemporaryState;
  delete[] this->ProdATemporaryState;
  if ((this->HilbertSpaceDimension != 0) && (this->Flag.Shared() == false) && (this->Flag.Used() == true))
...
AbstractHilbertSpace* BosonOnSphereWithSpinFast::Clone()
{
  return new BosonOnSphereWithSpinFast(*this);
}
...
List<AbstractQuantumNumber*> BosonOnSphereWithSpinFast::GetQuantumNumbers ()
{
...
AbstractQuantumNumber* BosonOnSphereWithSpinFast::GetQuantumNumber (int index)
{
...
AbstractHilbertSpace* BosonOnSphereWithSpinFast::ExtractSubspace (AbstractQuantumNumber& q, 
...
int BosonOnSphereWithSpinFast::AddAddAdAd (int index, int m1, int m2, int n1, int n2, double& coefficient)
{
...
int BosonOnSphereWithSpinFast::AduAduAuAu (int index, int m1, int m2, int n1, int n2, double& coefficient)
{
  return this->HilbertSpaceDimension;
}
...
int BosonOnSphereWithSpinFast::AddAduAdAu (int index, int m1, int m2, int n1, int n2, double& coefficient)
{
  return this->HilbertSpaceDimension;
}
...
int BosonOnSphereWithSpinFast::AduAdu (int m1, int m2, double& coefficient)
{
  for (int i = 0; i < this->NbrLzValue; ++i)
...
int BosonOnSphereWithSpinFast::AddAdd (int m1, int m2, double& coefficient)
{
  for (int i = 0; i < this->NbrLzValue; ++i)
    this->TemporaryState[i] = this->ProdATemporaryState[i];
...
int BosonOnSphereWithSpinFast::AduAdd (int m1, int m2, double& coefficient)
{
  for (int i = 0; i < this->NbrLzValue; ++i)
    this->TemporaryState[i] = this->ProdATemporaryState[i];
  ++this->TemporaryState[m2];
...
double BosonOnSphereWithSpinFast::AuAu (int index, int n1, int n2)
{
...
double BosonOnSphereWithSpinFast::AdAd (int index, int n1, int n2)
{
  int CurrentLzMaxUp, CurrentLzMaxDown;
  this->FermionToBoson(this->StateDescriptionUp[index], this->StateDescriptionDown[index], this->StateInfo[index],
		       ProdATemporaryState, CurrentLzMaxUp, CurrentLzMaxDown);
...
double BosonOnSphereWithSpinFast::AuAd (int index, int n1, int n2)
{
  int CurrentLzMaxUp, CurrentLzMaxDown;
  this->FermionToBoson(this->StateDescriptionUp[index], this->StateDescriptionDown[index], this->StateInfo[index],
		       ProdATemporaryState, CurrentLzMaxUp, CurrentLzMaxDown);
...
double BosonOnSphereWithSpinFast::ProdA (int index, int* n, int* spinIndices, int nbrIndices)
{
  int CurrentLzMaxUp, CurrentLzMaxDown;
  this->FermionToBoson(this->StateDescriptionUp[index], this->StateDescriptionDown[index], this->StateInfo[index],
		       ProdATemporaryState, CurrentLzMaxUp, CurrentLzMaxDown);
...
int BosonOnSphereWithSpinFast::ProdAd (int* m, int* spinIndices, int nbrIndices, double& coefficient)
{
  int i = 0;
...
double BosonOnSphereWithSpinFast::AduAu (int index, int m)
{
...
double BosonOnSphereWithSpinFast::AddAd (int index, int m)
{
  unsigned Info = this->StateInfo[index];
...
// coefficient = reference on the double where the multiplicative factor has to be stored
// return value = index of the destination state 
int BosonOnSphereWithSpinFast::AduAu (int index, int m, int n, double& coefficient)
{
  int CurrentLzMaxUp, CurrentLzMaxDown;
  this->FermionToBoson(this->StateDescriptionUp[index], this->StateDescriptionDown[index], this->StateInfo[index],
		       TemporaryState, CurrentLzMaxUp, CurrentLzMaxDown);
...
// coefficient = reference on the double where the multiplicative factor has to be stored
// return value = index of the destination state 
int BosonOnSphereWithSpinFast::AddAd (int index, int m, int n, double& coefficient)
{
  int CurrentLzMaxUp, CurrentLzMaxDown;
  this->FermionToBoson(this->StateDescriptionUp[index], this->StateDescriptionDown[index], this->StateInfo[index],
		       TemporaryState, CurrentLzMaxUp, CurrentLzMaxDown);
...
// coefficient = reference on the double where the multiplicative factor has to be stored
// return value = index of the destination state 
int BosonOnSphereWithSpinFast::AduAd (int index, int m, int n, double& coefficient)
{
  return this->HilbertSpaceDimension;
}
...
// coefficient = reference on the double where the multiplicative factor has to be stored
// return value = index of the destination state 
int BosonOnSphereWithSpinFast::AddAu (int index, int m, int n, double& coefficient)
{
  return this->HilbertSpaceDimension;
}
...
int BosonOnSphereWithSpinFast::FindStateIndex(unsigned* stateDescription)
{
  unsigned long FinalStateUp;
  unsigned long FinalStateDown;
  int LzMaxUp, LzMaxDown;
  this->BosonToFermion(FinalStateUp, FinalStateDown, LzMaxUp, LzMaxDown, stateDescription);
...
int BosonOnSphereWithSpinFast::FindStateIndex(char* stateDescription)
{
  char** TmpDescription;
...
//
void BosonOnSphereWithSpinFast::ShellSortAux(unsigned length, unsigned long* sortArray, unsigned *auxArray, int *auxArray2)
{
...
int BosonOnSphereWithSpinFast::GetLzValue(int j)
{
  return this->TotalLz;
}
...
ostream& BosonOnSphereWithSpinFast::PrintState (ostream& Str, int state)
{
  int CurrentLzMaxUp, CurrentLzMaxDown;
...
ostream& BosonOnSphereWithSpinFast::PrintState (ostream& Str, unsigned *myState)
{
  int i = 0;
...
int BosonOnSphereWithSpinFast::GenerateStates(int nbrBosonsUp, int nbrBosonsDown, int lzMax, int currentLzMax, int totalLz, int pos, int level)
{
#ifdef TESTING
...
/*
int BosonOnSphereWithSpinFast::GenerateStates(int nbrBosons, int lzMax, int currentLzMax, int totalLz, int pos)
{
...
void BosonOnSphereWithSpinFast::GenerateLookUpTable(int memory)
{
  ...
  for (unsigned i=0; i<NbrStatesUp; ++i)
    {
      ...
      this->TensoredLzMax[i] = this->StateLzMaxUp[TmpBlockStart[i]]+this->NbrBosonsUp;
...
//	      CurrentLookUpTableValue = TmpLookUpTableValue;
  ...
  */
  ...
  for (int i=0; i<this->HilbertSpaceDimension; ++i)
    {
      DownElementLzMax = this->StateInfo[i] >> 16;
...
long BosonOnSphereWithSpinFast::EvaluateHilbertSpaceDimension(int nbrBosons, int lzMax, int totalLz, int totalSpin)
{
...
long BosonOnSphereWithSpinFast::ShiftedEvaluateHilbertSpaceDimension(int nbrBosons, int lzMax, int totalLz, int totalSpin)
{
...
Complex BosonOnSphereWithSpinFast::EvaluateWaveFunction (RealVector& state, RealVector& position, AbstractFunctionBasis& basis)
{
...
Complex BosonOnSphereWithSpinFast::EvaluateWaveFunctionWithTimeCoherence (RealVector& state, RealVector& position, AbstractFunctionBasis& basis, 
							      int nextCoordinates)
{
...
void BosonOnSphereWithSpinFast::InitializeWaveFunctionEvaluation (bool timeCoherence)
{
...
RealSymmetricMatrix  BosonOnSphereWithSpinFast::EvaluatePartialDensityMatrix (int subsytemSize, int nbrBosonSector, int lzSector, RealVector& groundState)
{
  ...
  if (NbrBosonsComplementarySector == 0)
      ...
      if (ShiftedLzComplementarySector != 0)
	{
      ...
      BosonOnSphereWithSpinFast TmpDestinationHilbertSpace(nbrBosonSector, lzSector, subsytemSize - 1);
...
RealVector BosonOnSphereWithSpinFast::ForgeU1FromSU2(RealVector& state, BosonOnSphere& u1Space)
{
...
//
// state = given state
double BosonOnSphereWithSpinFast::MeanSxValue(RealVector& state)
{
  double Coefficient;
...
//
// state = given state
double BosonOnSphereWithSpinFast::MeanSzValue(RealVector& state)
{
  double Result = 0.0;
  int Dim = this->HilbertSpaceDimension;
