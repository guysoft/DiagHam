...
//		  cout << this->InteractionFactorsupdownupdown[i][Index] << " " << Tmp << " | ";
...
//		  cout << this->InteractionFactorsupdownupdown[i][Index] << " " << Tmp << " "  << this->ComputeTransfomationBasisContribution(OneBodyBasis, Index1, Index2, Index3, Index4, 0, 1, 0, 1, 1, 2, 1, 2) << endl;
