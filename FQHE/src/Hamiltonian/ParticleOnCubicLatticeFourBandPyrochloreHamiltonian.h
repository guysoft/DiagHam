													 ...
													 int siteIndex1, int siteIndex2, int siteIndex3, int siteIndex4)
{
  ...
  return ((oneBodyBasis[momentumIndex1][siteIndex1][energyIndex1]) * (oneBodyBasis[momentumIndex2][siteIndex2][energyIndex2]) * Conj(oneBodyBasis[momentumIndex3][siteIndex3][energyIndex3]) * Conj(oneBodyBasis[momentumIndex4][siteIndex4][energyIndex4])); 
}
