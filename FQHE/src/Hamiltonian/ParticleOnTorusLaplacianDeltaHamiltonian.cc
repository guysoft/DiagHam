...
void ParticleOnTorusLaplacianDeltaHamiltonian::SetHilbertSpace (AbstractHilbertSpace* hilbertSpace)
{
  delete[] this->InteractionFactors;
  if (this->FastMultiplicationFlag == true)
    {
...
void ParticleOnTorusLaplacianDeltaHamiltonian::ShiftHamiltonian (double shift)
{
...
void ParticleOnTorusLaplacianDeltaHamiltonian::EvaluateInteractionFactors()
{
  int Pos = 0;
  int m4;
