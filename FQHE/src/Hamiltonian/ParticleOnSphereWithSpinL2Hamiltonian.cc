...
ParticleOnSphereWithSpinL2Hamiltonian::ParticleOnSphereWithSpinL2Hamiltonian(ParticleOnSphereWithSpin* particles, int nbrParticles, int lzmax, int totalLz, int totalSz,
									     AbstractArchitecture* architecture, double l2Factor, double s2Factor, long memory, bool onDiskCacheFlag,
									     char* precalculationFileName)
{
  this->Particles = particles;
  this->LzMax = lzmax;
  ...
  this->L2Factor = l2Factor;
  this->L2Hamiltonian = 0;
  this->S2Hamiltonian = new ParticleOnSphereWithSpinS2Hamiltonian(particles, this->NbrParticles, this->LzMax, this->TotalLz, totalSz, architecture, memory);
  this->Architecture = architecture;
  this->EvaluateInteractionFactors();
  this->HamiltonianShift = 0.25 * this->L2Factor * ((double) (this->TotalLz * this->TotalLz));
  long MinIndex;
