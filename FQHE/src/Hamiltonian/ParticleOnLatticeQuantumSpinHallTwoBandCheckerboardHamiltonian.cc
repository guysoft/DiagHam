...
ParticleOnLatticeQuantumSpinHallTwoBandCheckerboardHamiltonian::ParticleOnLatticeQuantumSpinHallTwoBandCheckerboardHamiltonian(ParticleOnSphereWithSpin* particles, int nbrParticles, int nbrSiteX, 
															       int nbrSiteY, double uPotential, double t1, double t2, double t2p, double mixingTermNorm, double mixingTermArg, double gammaX, double gammaY, bool flatBandFlag, AbstractArchitecture* architecture, long memory)
{
...
void ParticleOnLatticeQuantumSpinHallTwoBandCheckerboardHamiltonian::EvaluateInteractionFactors()
{
  ...
  for (int kx = 0; kx < this->NbrSiteX; ++kx)
	...
	TmpOneBodyHamiltonian.SetMatrixElement(2, 1, - I() * this->MixingTerm);
	TmpOneBodyHamiltonian.SetMatrixElement(3, 0, I() * this->MixingTerm);
	  ...
	  for (int j1 = 0; j1 < this->NbrIntraSectorIndicesPerSum[i]; ++j1)
	      ...
	      for (int j2 = 0; j2 < this->NbrIntraSectorIndicesPerSum[i]; ++j2)
		{
		  ...
		  //  upup upup coefficient
 		  ...
 		  this->InteractionFactorsupupupup[i][Index] -= this->ComputeTransfomationBasisContribution(OneBodyBasis, Index2, Index1, Index3, Index4, 0, 0, 0, 0, 0, 2, 0, 2) * this->ComputeTwoBodyMatrixElementAUpADown(kx1, ky1, kx4, ky4) * this->ComputeTwoBodyMatrixElementAUpADown(kx2, ky3, kx3, ky3);;
		  ...
		  // downdown downdown coefficient
 		  ...
 		  this->InteractionFactorsdowndowndowndown[i][Index] -= this->ComputeTransfomationBasisContribution(OneBodyBasis, Index2, Index1, Index3, Index4, 1, 1, 1, 1, 0, 2, 0, 2) * this->ComputeTwoBodyMatrixElementAUpADown(kx1, ky1, kx4, ky4) * this->ComputeTwoBodyMatrixElementAUpADown(kx2, ky3, kx3, ky3);
      ...
      for (int i = 0; i < this->NbrInterSectorSums; ++i)
	{
	  ...
	  for (int j1 = 0; j1 < this->NbrInterSectorIndicesPerSum[i]; ++j1)
	      ...
	      for (int j2 = 0; j2 < this->NbrIntraSectorIndicesPerSum[i]; ++j2)
		{
		  ...
		  this->InteractionFactorsupupupdown[i][Index] -= this->ComputeTransfomationBasisContribution(OneBodyBasis, Index2, Index1, Index3, Index3, 0, 0, 0, 1, 0, 1, 0, 1) * this->ComputeTwoBodyMatrixElementAUpBUp(kx1, ky1, kx4, ky4);
		  ...
		  this->InteractionFactorsupupupdown[i][Index] -= this->ComputeTransfomationBasisContribution(OneBodyBasis, Index2, Index1, Index3, Index3, 0, 0, 0, 1, 2, 3, 2, 3) * this->ComputeTwoBodyMatrixElementAUpBUp(kx1, ky1, kx4, ky4);
		  ...
		  this->InteractionFactorsdowndownupdown[i][Index] -= this->ComputeTransfomationBasisContribution(OneBodyBasis, Index2, Index1, Index3, Index3, 1, 1, 0, 1, 0, 1, 0, 1) * this->ComputeTwoBodyMatrixElementAUpBUp(kx1, ky1, kx4, ky4);
