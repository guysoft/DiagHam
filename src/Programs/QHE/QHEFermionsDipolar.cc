...
#include "Hamiltonian/QHEHamiltonian/ParticleOnSphereDipolarHamiltonian.h"
...
int main(int argc, char** argv)
{
  ...
  for (; L <= Max; L += 2)
	...
	Architecture = new SMPArchitecture(NbrProcessor);
      ...
      Hamiltonian = new ParticleOnSphereDipolarHamiltonian(&Space, NbrFermions, LzMax, Architecture, Memory, LoadPrecalculationFileName);
