...
int main(int argc, char** argv)
{
  ...
  if (Manager.ProceedOptions(argv, argc, cout) == false)
    {
      cout << "see man page for option syntax or type QHEBosonsLaplacianDelta -h" << endl;
      return -1;
    }
  ...
  sprintf (OutputNameLz, "bosons_v2_n_%d_2s_%d_lz.dat", NbrBosons, LzMax);
  ...
  for (; L <= Max; L += 2)
	...
	PseudoPotential[i] = 0.0;
      PseudoPotential[2] = 1.0;
      Hamiltonian = new ParticleOnSphereGenericHamiltonian(Space, NbrBosons, LzMax, PseudoPotential, 
      ...
      if (((BooleanOption*) Manager["eigenstate"])->GetBoolean() == true)	
	{
	  ...
	  sprintf (EigenvectorName, "bosons_v2_n_%d_2s_%d_lz_%d", NbrBosons, LzMax, L);
	}
