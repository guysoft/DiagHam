...
#ifndef NEWPERIODICQUANTUMDOTS3DHAMILTONIAN_H
#define NEWPERIODICQUANTUMDOTS3DHAMILTONIAN_H
...
class NewPeriodicQuantumDots3DHamiltonian : public AbstractHamiltonian
{
 ...
 public:
  ...
  NewPeriodicQuantumDots3DHamiltonian(Periodic3DOneParticle* space, double xSize, double ySize, double zSize, double mux, double muy, double muz, int nbrCellX, int nbrCellY, int nbrCellZ, ThreeDPotential* PotentialInput);

  // copy constructor (without duplicating datas)
  //
  // hamiltonian = reference on hamiltonian to copy
  
  NewPeriodicQuantumDots3DHamiltonian(const NewPeriodicQuantumDots3DHamiltonian& hamiltonian);

  // destructor
  //
  
  ~NewPeriodicQuantumDots3DHamiltonian();
...
inline AbstractHilbertSpace* NewPeriodicQuantumDots3DHamiltonian::GetHilbertSpace ()
{
  return this->Space;
}
...
inline int NewPeriodicQuantumDots3DHamiltonian::GetHilbertSpaceDimension ()
{
