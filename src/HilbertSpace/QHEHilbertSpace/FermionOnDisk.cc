...
Complex FermionOnDisk::EvaluateWaveFunction (RealVector& state, RealVector& position, AbstractFunctionBasis& basis,
...
void FermionOnDisk::InitializeWaveFunctionEvaluation (bool timeCoherence)
{
}
