...
void AbstractMPOperatorOBC::ComputeLCore(Tensor3<double> & L)
{
...
void AbstractMPOperatorOBC::ComputeRCore(Tensor3<double> & R)
{
  int BondDimensionRight = this->Site->GetBondDimensionRight();
  int BondDimensionLeft = this->Site->GetBondDimensionLeft();
...
RealVector& AbstractMPOperatorOBC::LowLevelMultiplyCore(RealVector& vSource, RealVector& vDestination, 
...
RealVector& AbstractMPOperatorOBC::LowLevelMultiplyTwoSitesCore(RealVector& vSource, RealVector& vDestination,  int firstComponent, int nbrComponent)
{
/*  timeval TotalStartingTime;
  timeval TotalEndingTime;
  gettimeofday (&TotalStartingTime, 0)
