...
//                               int rowShift, int columnShift);
  void ReorthogonalizeVectors (ComplexVector* vectors, int nbrVectors, HermitianMatrix& matrix,
			       int rowShift, int columnShift);


  void TestOrthogonality (ComplexVector* vectors, int nbrVectors, ComplexVector* otherVectors = 0, int nbrOtherVectors = 0);
